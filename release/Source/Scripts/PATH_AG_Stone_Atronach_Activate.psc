Scriptname PATH_AG_Stone_Atronach_Activate extends ObjectReference  
...
FUNCTION addSign(int ability_index)
	...
	if(ability_index == ABILITY_CODE_1)
		Game.getPlayer().addSpell(Stone_Atronach_Ability_1)

    elseif(ability_index == ABILITY_CODE_2)
		game.getPlayer().addSpell(Stone_Atronach_Ability_2)
    
    elseif(ability_index == ABILITY_CODE_3)
		game.getPlayer().addSpell(Stone_Atronach_Ability_3)
