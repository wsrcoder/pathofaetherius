Scriptname PATH_AG_Stone_Guile_Activate extends ObjectReference  
...
FUNCTION addSign(int ability_index)
	...
	if(ability_index == ABILITY_CODE_1)
		Game.getPlayer().addSpell(Stone_Guile_Ability_1)

    elseif(ability_index == ABILITY_CODE_2)
		game.getPlayer().addSpell(Stone_Guile_Ability_2)
