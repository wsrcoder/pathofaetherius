Scriptname PATH_AG_Stone_Serpent_Activate extends ObjectReference  
...
FUNCTION addSign(int ability_index)
	...
	if(ability_index == ABILITY_CODE_1)
		Game.getPlayer().addSpell(Stone_Serpent_Ability_1)

    elseif(ability_index == ABILITY_CODE_2)
		game.getPlayer().addSpell(Stone_Serpent_Ability_2)
