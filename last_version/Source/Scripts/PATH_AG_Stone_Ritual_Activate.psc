Scriptname PATH_AG_Stone_Ritual_Activate extends ObjectReference  
...
Auto State base
	...
	event OnActivate(ObjectReference obj)
        ...
        elseif (button_code == ABILITY_CODE_2) 
                removeSign()
				addSign(ABILITY_CODE_2)
					
				SELF.playAnimation("playanim01")
					
				utility.wait(15)

        elseif (button_code == ABILITY_CODE_3) 
                removeSign()
				addSign(ABILITY_CODE_3)
					
				SELF.playAnimation("playanim01")
					
				utility.wait(15)
        elseif (button_code == ABILITY_CODE_4) 
                removeSign()
				addSign(ABILITY_CODE_4)
...
FUNCTION addSign(int ability_index)
	...
	if(ability_index == ABILITY_CODE_1)
		Game.getPlayer().addSpell(Stone_Ritual_Ability_1)

    elseif(ability_index == ABILITY_CODE_2)
		game.getPlayer().addSpell(Stone_Ritual_Ability_2)
    
    elseif(ability_index == ABILITY_CODE_3)
		game.getPlayer().addSpell(Stone_Ritual_Ability_3)
 
    elseif(ability_index == ABILITY_CODE_4)
		game.getPlayer().addSpell(Stone_Ritual_Ability_4)
    endif
EndFunction
